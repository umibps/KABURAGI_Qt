...
#include <QtCore/qtconfigmacros.h> // Q_INSIGHTTRACKER_EXPORT
...
#  define QT_INSIGHTTRACKER_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_INSIGHTTRACKER_CONSTEXPR_INLINE_SINCE(major, minor) \
