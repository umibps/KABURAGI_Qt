...
#include <QtCore/qtconfigmacros.h> // Q_INSIGHTTRACKERQML_EXPORT
...
#  define QT_INSIGHTTRACKERQML_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_INSIGHTTRACKERQML_CONSTEXPR_INLINE_SINCE(major, minor) \
