...
void* PencilGUI_New(APPLICATION* app, BRUSH_CORE* core)
{
	ToolBoxWidget *tool_box = (ToolBoxWidget*)app->widgets;
	
	QWidget *detail_layout_widget = tool_box->getDetailLayoutWidget();
	PencilGUI *pencil = new PencilGUI(core);
	core->brush_data = (void*)pencil;
