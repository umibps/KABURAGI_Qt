...
#define NUM_PERSPECTIVE_RULER_POINTS 3
...
typedef enum _ePERSPECTIVE_RULER_FLAGS
{
	PERSPECTIVE_RULER_FLAGS_DRAW_LINE = 0x01
} ePERSPECTIVE_RULER_FLAGS;

typedef struct _PERSPECTIVE_RULER
{
	ePERSPECTIVE_RULER_TYPE type;
	FLOAT_T start_point[NUM_PERSPECTIVE_RULER_POINTS][2][2];
