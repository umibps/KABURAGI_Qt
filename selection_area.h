...
typedef enum _eSELECTION_BLEND_MODE
{
	...
	NUM_SELECTION_BLEND_MODE
} eSELECTION_BLEND_MODE;

// 関数のプロトタイプ宣言
EXTERN int UpdateSelectionArea(SELECTION_AREA* area, LAYER* selection, LAYER* disp_temp);
...
* num_steps : 拡大するピクセル数						  *
*****************************************************/
EXTERN void ExtendSelectionArea(DRAW_WINDOW* canvas, int num_steps);
